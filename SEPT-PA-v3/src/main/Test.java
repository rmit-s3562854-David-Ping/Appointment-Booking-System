...
public class Test {
	public static void main(String[] args) {
		...
		LocalDateTime start = LocalDateTime.of(2017, 3, 15, 9, 0);//year, month, day, hour, min
		LocalDateTime start2 = LocalDateTime.of(2017, 3, 23, 9, 0);//year, month, day, hour, min
		LocalDateTime start3 = LocalDateTime.of(2017, 3, 17, 9, 0);//year, month, day, hour, min
		LocalDateTime start4 = LocalDateTime.of(2017, 3, 18, 9, 0);//year, month, day, hour, min
		LocalDateTime end = LocalDateTime.of(2017, 3, 15, 19, 0);//year, month, day, hour, min
		LocalDateTime end2 = LocalDateTime.of(2017, 3, 23, 19, 0);//year, month, day, hour, min
		LocalDateTime end3 = LocalDateTime.of(2017, 3, 17, 19, 0);//year, month, day, hour, min
		LocalDateTime end4 = LocalDateTime.of(2017, 3, 18, 19, 0);//year, month, day, hour, min
