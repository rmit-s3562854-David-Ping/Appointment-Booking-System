...
public class chooseBusinessPageController {
	...
	private void initialize() {
		...
		listView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
			//This is a listener. It waits for a new selection from the table. How i change the image files.
		    @Override
		    public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
		    	//The image value is set to change to the 'newValue' which is the new businessName.
		    	//Clients must save their business image under their businessName ie. 'Nike.png'
...
public void loadCustomerSelection(){
	//When the user has selected a business, we call readBusiness and pass the selected value... EASY!
